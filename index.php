...
<iframe
    ...
    width="350"
    height="430"
    src="https://console.dialogflow.com/api-client/demo/embedded/e9c963da-98f8-4398-aaa1-da0db55f05cc">
</iframe>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="79OvMS9bX-w" id="video"> <img src="images/banner2.jpg" alt="" class="img-responsive" /> </div>
		</div>
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Address</h4>
					<p>IncubationCentre,</p>
					<p>Karachi Fast City Campus.</p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:k173934@nu.edu.pk">k173934@nu.edu.pk</a>
						<span><a href="mailto:k173684@nu.edu.pk">k173684@nu.edu.pk</a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
